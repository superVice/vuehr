  ...
  >
    <el-tabs v-model="activeAdd" type="card">
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple-light">
              <el-form-item label="随访日期" class="item" prop="vist_time">
                <el-date-picker v-model="formAdd.vist_time" type="date" placeholder="选择日期"></el-date-picker>
              </el-form-item>
            </div>
          </el-col>
          <!-- 随访形式 -->
            ...
            <el-col :span="8">
              <div class="grid-content bg-purple-light">
                <el-form-item label="1.乏力与疲劳" class="item">
                  <el-select v-model="formAdd.hzzz['乏力与疲劳']" placeholder="请选择乏力与疲劳" clearable>
                    <el-option v-for="item in template_data.症状.乏力与疲劳" :key="item" :value="item"></el-option>
                  </el-select>
                </el-form-item>
              </div>
            </el-col>
            ...
            <el-col :span="8">
              <div class="grid-content bg-purple-light">
                <el-form-item label="2.气短/呼吸困难" class="item">
                  <el-select v-model="formAdd.hzzz['气短/呼吸困难']" placeholder="请选择气短/呼吸困难">
                    <el-option
            ...
            <el-col :span="8">
              <div class="grid-content bg-purple-light">
                <el-form-item label="3.活动能力" class="item">
                  <el-select v-model="formAdd.hzzz['活动能力']" placeholder="请选择活动能力">
                    <el-option v-for="item in template_data.症状.活动能力" :key="item" :value="item"></el-option>
                  </el-select>
                </el-form-item>
              </div>
            </el-col>
            <el-col :span="8">
              <div class="grid-content bg-purple-light">
                <el-form-item label="4.自理能力" class="item">
                  <el-select v-model="formAdd.hzzz['自理能力']" placeholder="请选择自理能力">
                    <el-option v-for="item in template_data.症状.自理能力" :key="item" :value="item"></el-option>
                  </el-select>
                </el-form-item>
              </div>
            </el-col>
            <el-col :span="8">
              <div class="grid-content bg-purple-light">
                <el-form-item label="5.日常活动" class="item">
                  <el-select v-model="formAdd.hzzz['日常活动']" placeholder="请选择日常活动">
                    <el-option v-for="item in template_data.症状.日常活动" :key="item" :value="item"></el-option>
                  </el-select>
                </el-form-item>
              </div>
            </el-col>
            <el-col :span="8">
              <div class="grid-content bg-purple-light">
                <el-form-item label="6.其它躯体不适" class="item">
                  <el-select v-model="formAdd.hzzz['其它躯体不适']" placeholder="请选择其它躯体不适">
                    <el-option v-for="item in template_data.症状.其它躯体不适" :key="item" :value="item"></el-option>
                  </el-select>
                </el-form-item>
              </div>
            </el-col>
            <el-col :span="8">
              <div class="grid-content bg-purple-light">
                <el-form-item label="7.焦虑/抑郁" class="item">
                  <el-select v-model="formAdd.hzzz['焦虑/抑郁']" placeholder="请选择焦虑/抑郁">
                    <el-option v-for="item in template_data.症状['焦虑/抑郁']" :key="item" :value="item"></el-option>
                  </el-select>
                </el-form-item>
              </div>
            </el-col>
            <el-col :span="8">
              <div class="grid-content bg-purple">
                <el-form-item label="8.生活质量自评(分)" class="item">
                  <el-input v-model="formAdd.hzzz['生活质量自评']" placeholder="请输入生活质量自评" maxlength="4"></el-input>
                </el-form-item>
                <!-- 备注：0-100分，100分最高 -->
              </div>
            </el-col>
            <el-col :span="8">
              <div class="grid-content bg-purple-light">
                <el-form-item label="9.充血性心力衰竭症状" class="item">
                  <el-select v-model="formAdd.hzzz['充血性心力衰竭症状']" placeholder="请选择充血性心力衰竭症状">
                    <el-option
            ...
            <el-col :span="8">
              <div class="grid-content bg-purple-light">
                <el-form-item label="心脏协会分级" class="item">
                  <el-select v-model="formAdd.hzzz['心力衰竭症状等级']" placeholder="请选择心力衰竭症状等级">
                    <el-option
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple-light">
            <el-form-item label="3.基础血压低" class="item">
              <el-select v-model="formAdd.shfs['基础血压低']" placeholder="请选择基础血压低">
                <el-option v-for="item in template_data.生活方式['基础血压低']" :key="item" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="grid-content bg-purple-light">
            <el-form-item label="4.基础心率低" class="item">
              <el-select v-model="formAdd.shfs['基础心率低']" placeholder="请选择基础心率低">
                <el-option v-for="item in template_data.生活方式['基础心率低']" :key="item" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="grid-content bg-purple-light">
            <el-form-item label="5.治疗依从性高" class="item">
              <el-select v-model="formAdd.shfs['治疗依从性高']" placeholder="请选择治疗依从性高">
                <el-option v-for="item in template_data.生活方式['治疗依从性高']" :key="item" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="grid-content bg-purple-light">
            <el-form-item label="7.患者本人重视程度高" class="item">
              <el-select v-model="formAdd.shfs['患者本人重视程度高']" placeholder="请选择患者本人重视程度高">
                <el-option
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple-light">
            <el-form-item label="9.患者本人信心" class="item">
              <el-select v-model="formAdd.shfs['患者本人信心']" placeholder="请选择患者本人信心">
                <el-option v-for="item in template_data.生活方式['患者本人信心']" :key="item" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="grid-content bg-purple-light">
            <el-form-item label="10.家属关心程度" class="item">
              <el-select v-model="formAdd.shfs['家属关心程度']" placeholder="请选择家属关心程度">
                <el-option v-for="item in template_data.生活方式['家属关心程度']" :key="item" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="grid-content bg-purple-light">
            <el-form-item label="11.有氧运动" class="item">
              <el-select v-model="formAdd.shfs['有氧运动']" placeholder="请选择有氧运动">
                <el-option v-for="item in template_data.生活方式['有氧运动']" :key="item" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="grid-content bg-purple-light">
            <el-form-item label="13.经济条件(生活及治病)" class="item">
              <el-select v-model="formAdd.shfs['经济条件']" placeholder="经济条件(满足生活及治病需要)">
                <el-option v-for="item in template_data.生活方式['经济条件']" :key="item" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="grid-content bg-purple-light">
            <el-form-item label="14.对社会及生活的情感" class="item">
              <el-select v-model="formAdd.shfs['对社会及生活的情感']" placeholder="请选择对社会及生活的情感">
                <el-option
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple-light">
            <el-form-item label="15.人际关系" class="item">
              <el-select v-model="formAdd.shfs['人际关系']" placeholder="请选择人际关系">
                <el-option v-for="item in template_data.生活方式['人际关系']" :key="item" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="grid-content bg-purple-light">
            <el-form-item label="16.对患病及衰老的态度" class="item">
              <el-select v-model="formAdd.shfs['对患病及衰老的态度']" placeholder="请选择对患病及衰老的态度">
                <el-option
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple-light">
            <el-form-item label="17.每天进食食盐" class="item">
              <el-select v-model="formAdd.shfs['每天进食食盐']" placeholder="请选择每天进食食盐">
                <el-option v-for="item in template_data.生活方式['每天进食食盐']" :key="item" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="grid-content bg-purple-light">
            <el-form-item label="18.食欲" class="item">
              <el-select v-model="formAdd.shfs['食欲']" placeholder="请选择食欲">
                <el-option v-for="item in template_data.生活方式['食欲']" :key="item" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </div>
        </el-col>
      ...
      <el-tab-pane label="体格检查与生命体征" name="add_four">
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="1.体重(kg)" class="item">
                <el-input v-model="formAdd.tzytg['体重(kg)']" placeholder="请输入体重(kg)" maxlength="4"></el-input>
              </el-form-item>
            </div>
          </el-col>
          <el-col :span="8">
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="3.体重指数" class="item">
                <el-input v-model="formAdd.tzytg['体重指数']" placeholder="请输入体重指数" maxlength="4"></el-input>
              </el-form-item>
            </div>
          </el-col>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="7.肺咯音" class="item">
                <el-select v-model="formAdd.tzytg['肺咯音']" placeholder="请选择是否">
                  <el-option v-for="item in base_selarr" :key="item" :value="item"></el-option>
                </el-select>
              </el-form-item>
            </div>
          </el-col>
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="8. 颈静脉压升高体征" class="item">
                <el-select v-model="formAdd.tzytg['颈静脉压升高体征']" placeholder="请选择是否">
                  <el-option v-for="item in base_selarr" :key="item" :value="item"></el-option>
                </el-select>
              </el-form-item>
            </div>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="9. 外周性水肿" class="item">
                <el-select v-model="formAdd.tzytg['外周性水肿']" placeholder="请选择是否">
                  <el-option v-for="item in base_selarr" :key="item" :value="item"></el-option>
                </el-select>
              </el-form-item>
            </div>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="10. 第三心音" class="item">
                <el-select v-model="formAdd.tzytg['第三心音']" placeholder="请选择是否">
                  <el-option v-for="item in base_selarr" :key="item" :value="item"></el-option>
                </el-select>
              </el-form-item>
            </div>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="11. 外周滴灌注体征" class="item">
                <el-select v-model="formAdd.tzytg['外周滴灌注体征']" placeholder="请选择是否">
                  <el-option v-for="item in base_selarr" :key="item" :value="item"></el-option>
                </el-select>
              </el-form-item>
            </div>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="12. 肝颈静脉回流征" class="item">
                <el-select v-model="formAdd.tzytg['肝颈静脉回流征']" placeholder="请选择肝颈静脉回流征">
                  <el-option v-for="item in gjjmhlz" :key="item" :value="item"></el-option>
                </el-select>
              </el-form-item>
            </div>
          </el-col>
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="13. 皮肤湿度" class="item">
                <el-select v-model="formAdd.tzytg['皮肤湿度']" placeholder="请选择皮肤湿度">
                  <el-option v-for="item in pfsd" :key="item" :value="item"></el-option>
                </el-select>
              </el-form-item>
            </div>
          </el-col>
        ...
        <el-tag style="margin-bottom:10px" type="danger">* 4. 坐位动脉血压输入：收缩压/舒张压，*/* mmHg！</el-tag>
        <br />
        <el-tag style="margin-bottom:10px" type="danger">* 8. 颈静脉压升高体征即：颈静脉充盈！</el-tag>
      </el-tab-pane>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="12. C反应蛋白" class="item">
                <el-input v-model="formAdd.jcjg['C反应蛋白']" placeholder="请输入C反应蛋白" maxlength="4"></el-input>
              </el-form-item>
            </div>
          </el-col>
          <el-col :span="8">
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="14. 心电图是否检测" class="item">
                <el-select v-model="formAdd.jcjg['心电图']['是否检测过']" placeholder="请选择是否检测">
                  <el-option v-for="item in base_selarr" :key="item" :value="item"></el-option>
                </el-select>
              </el-form-item>
            </div>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="心电图节律" class="item">
                <el-select v-model="formAdd.jcjg['心电图']['心电图内容']['心电图节律']" placeholder="请选择心电图节律">
                  <el-option v-for="item in xdtjl" :key="item" :value="item"></el-option>
                </el-select>
              </el-form-item>
            </div>
          </el-col>
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="左束支传导阻滞" class="item">
                <el-select
                  v-model="formAdd.jcjg['心电图']['心电图内容']['左束支传导阻滞']"
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="15. 超声心动图(近12月内)" class="item">
                <el-select v-model="formAdd.jcjg['超声心动图(近12月内)']['是否检测过']" placeholder="请选择是否检测">
                  <el-option v-for="item in base_selarr" :key="item" :value="item"></el-option>
                </el-select>
              </el-form-item>
            </div>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="超声心动图内容" class="item" prop="日期">
                <el-date-picker
                  v-model="formAdd.jcjg['超声心动图(近12月内)']['超声心动图内容']['日期']"
                  type="date"
                  placeholder="选择日期"
                ></el-date-picker>
              </el-form-item>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="射血分数(%)" class="item">
                <el-input
                  v-model="formAdd.jcjg['超声心动图(近12月内)']['超声心动图内容']['射血分数(%)']"
                  placeholder="射血分数(%)"
                  maxlength="4"
                ></el-input>
              </el-form-item>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="左心室舒张末期内径(mm)" class="item">
                <el-input
                  v-model="formAdd.jcjg['超声心动图(近12月内)']['超声心动图内容']['左心室舒张末期内径(mm)']"
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="肺静脉血流图" class="item">
                <el-input
                  v-model="formAdd.jcjg['超声心动图(近12月内)']['超声心动图内容']['肺静脉血流图']"
                  placeholder="肺静脉血流图"
                  maxlength="4"
                ></el-input>
              </el-form-item>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="E/A" class="item">
                <el-input
                  v-model="formAdd.jcjg['超声心动图(近12月内)']['超声心动图内容']['E/A']"
                  placeholder="E/A"
                  maxlength="4"
                ></el-input>
              </el-form-item>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="E/e" class="item">
                <el-input
                  v-model="formAdd.jcjg['超声心动图(近12月内)']['超声心动图内容']['E/e']"
                  placeholder="E/e"
                  maxlength="4"
                ></el-input>
              </el-form-item>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="左心房舒张末期内径(mm)" class="item">
                <el-input
                  v-model="formAdd.jcjg['超声心动图(近12月内)']['超声心动图内容']['左心房舒张末期内径(mm)']"
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="16. 6分钟步行测试" class="item">
                <el-select v-model="formAdd.jcjg['6分钟步行测试']['是否检测过']" placeholder="请选择是否检测">
                  <el-option v-for="item in base_selarr" :key="item" :value="item"></el-option>
                </el-select>
              </el-form-item>
            </div>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="步行距离" class="item">
                <el-input
                  v-model="formAdd.jcjg['6分钟步行测试']['步行测试内容']['步行距离']"
                  placeholder="步行距离"
                  maxlength="4"
                ></el-input>
              </el-form-item>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="步行前心率" class="item">
                <el-input
                  v-model="formAdd.jcjg['6分钟步行测试']['步行测试内容']['步行前心率']"
                  placeholder="步行前心率"
                  maxlength="4"
                ></el-input>
              </el-form-item>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="步行最快心率" class="item">
                <el-input
                  v-model="formAdd.jcjg['6分钟步行测试']['步行测试内容']['步行最快心率']"
                  placeholder="步行最快心率"
                  maxlength="4"
                ></el-input>
              </el-form-item>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="心率变化绝对值" class="item">
                <el-input
                  v-model="formAdd.jcjg['6分钟步行测试']['步行测试内容']['心率变化绝对值']"
                  placeholder="心率变化绝对值"
                  maxlength="4"
                ></el-input>
              </el-form-item>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="心率变异分数" class="item">
                <el-input
                  v-model="formAdd.jcjg['6分钟步行测试']['步行测试内容']['心率变异分数']"
                  placeholder="心率变异分数"
                  maxlength="4"
                ></el-input>
              </el-form-item>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="步行前血压" class="item">
                <el-input
                  v-model="formAdd.jcjg['6分钟步行测试']['步行测试内容']['步行前血压']"
                  placeholder="步行前血压"
                  maxlength="4"
                ></el-input>
              </el-form-item>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="步行最高血压" class="item">
                <el-input
                  v-model="formAdd.jcjg['6分钟步行测试']['步行测试内容']['步行最高血压']"
                  placeholder="步行最高血压"
                  maxlength="4"
                ></el-input>
              </el-form-item>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="血压变化绝对值" class="item">
                <el-input
                  v-model="formAdd.jcjg['6分钟步行测试']['步行测试内容']['血压变化绝对值']"
                  placeholder="血压变化绝对值"
                  maxlength="4"
                ></el-input>
              </el-form-item>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="因骨关节等病活动困难" class="item">
                <el-select
                  v-model="formAdd.jcjg['6分钟步行测试']['步行测试内容']['因骨关节等病活动困难']"
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">
              <el-form-item label="其它影响步行实验" class="item">
                <el-select
                  v-model="formAdd.jcjg['6分钟步行测试']['步行测试内容']['其它影响步行实验']"
                  placeholder="请选择其它影响步行实验"
                >
                  <el-option v-for="item in qtyxbxsy" :key="item" :value="item"></el-option>
                </el-select>
              </el-form-item>
            </div>
          </el-col>
      ...
      <el-tab-pane label="治疗药物(A心血管药物)" name="add_six">
         <!-- 血管紧张素转化为酶抑制剂（ACEI） -->
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple-light">
              <el-form-item label="是否使用" class="item">
                <el-select v-model="formAdd.zlyw_a.ACEI['是否使用']" placeholder="请选择是否使用">
                  <el-option v-for="item in base_selarr" :key="item" :value="item"></el-option>
                </el-select>
              </el-form-item>
            </div>
          ...
          <!-- <el-col :span="8">
              <div class="grid-content bg-purple-light">
                <el-form-item label="未用原因" class="item">
                  <el-select v-model="formAdd.zlyw_a.ACEI['未用']['原因']" placeholder="请选择未用原因" >
                    <el-option v-for="item in reason_a" :key="item" :value="item"></el-option>
                  </el-select>
                </el-form-item>
              </div>
          </el-col>-->
            ...
            <div class="grid-content bg-purple-light">
              <el-form-item label="症状" class="item">
                <el-select
                  ...
                  allow-create
                >
                  <el-option v-for="item in reason_b" :key="item" :value="item"></el-option>
                </el-select>
              </el-form-item>
            </div>
          </el-col>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple-light">
              <el-form-item label="药物达到目标剂量" class="item">
                ...
                >
                  <el-option v-for="item in this.base_selarr" :key="item" :value="item"></el-option>
                </el-select>
              </el-form-item>
            </div>
          </el-col>
      ...
      <!-- 治疗药物(B非心血管药物) -->
      <el-tab-pane label="治疗药物(B非心血管药物)" name="add_seven">
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-form-item label="1. 非甾体类抗炎药" class="item">
              <el-select v-model="formAdd.zlyw_b['非甾体类抗炎药']" placeholder="请选择非甾体类抗炎药">
                <el-option v-for="item in base_selarr" :key="item" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </div>
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-form-item label="2. 抗糖尿病药物" class="item">
              <el-select v-model="formAdd.zlyw_b['抗糖尿病药物']['是否服用']" placeholder="请选择抗糖尿病药物">
                <el-option v-for="item in base_selarr" :key="item" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </div>
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-form-item label="3. 抗抑郁药" class="item">
              <el-select v-model="formAdd.zlyw_b['抗抑郁药']" placeholder="请选择抗抑郁药">
                <el-option v-for="item in base_selarr" :key="item" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </div>
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-form-item label="4. 秋水仙碱" class="item">
              <el-select v-model="formAdd.zlyw_b['秋水仙碱']" placeholder="请选择秋水仙碱">
                <el-option v-for="item in base_selarr" :key="item" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </div>
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-form-item label="5. 甲状腺激素替代治疗" class="item">
              <el-select v-model="formAdd.zlyw_b['甲状腺激素替代治疗']" placeholder="请选择甲状腺激素替代治疗">
                <el-option v-for="item in base_selarr" :key="item" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </div>
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-form-item label="6. 参加随机对照临床研究" class="item">
              <el-select v-model="formAdd.zlyw_b['是否参加随机对照临床研究']" placeholder="请选择是否参加随机对照临床研究">
                <el-option v-for="item in base_selarr" :key="item" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </div>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        sfxs: [{ required: true, message: "请选择随访形式", trigger: "change" }]
      }
    };
  },
  methods: {
    ...
    //   var ways = Array.from(this.template_data.生活方式["饮酒情况"]);
